...
//			}, 0);
		...
		// --------- Drag & Drop events  ---------
		BX.bind(element, "dragover", function(){editor.On("OnIframeDragOver");});
		BX.bind(element, "dragenter", function(){editor.On("OnIframeDragEnter");});
		BX.bind(element, "dragleave", function(){editor.On("OnIframeDragLeave");});
		BX.bind(element, "dragexit", function(){editor.On("OnIframeDragExit");});
		BX.bind(element, "drop", function(){editor.On("OnIframeDrop");});
	...
	BXEditorIframeView.prototype._IEBodyClearHandler = function(e)
	{
		...
		{
			editor.util.ReplaceWithOwnChildren(p);
		}
