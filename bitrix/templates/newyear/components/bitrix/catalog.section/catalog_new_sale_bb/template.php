...
<div class="section_top">
	...
	<div class="sort_right">
		Сортировать: <a href="" class="act_sort">по цене</a> <a href="<?= $APPLICATION->GetCurPageParam("sort=dicount_count", array("SECTION", "SUB_SECTION"));?>">по размеру скидки</a>
	</div>
</div>
...
<?require($_SERVER["DOCUMENT_ROOT"]."/catalog/salenewyear/include/template_top.php");?>
<div class="mcontent">
...
<div class="item-cards-list-cnt">
    <ul class="item-cards-list matrix">
		...
		?>
		<? if($key == 6){?>
		<?require($_SERVER["DOCUMENT_ROOT"]."/catalog/salenewyear/include/template_center.php");?>
		<?}?>
