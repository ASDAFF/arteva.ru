<div class="wrap_filter_m">
	...
	<div class="filter_line_m flm2">
		...
		<a href="<?=$APPLICATION->GetCurPageParam("am=Y", array("PLACE1", "PLACE2", "PLACE3", "TIP_SV4", "PLACE5"));?>" class="filter_item_m <?=(isset($_GET["am"]))?"active_filt_i_m":"";?>">ВСЕ</a>
		<a href="<?=$APPLICATION->GetCurPageParam("PLACE1=41548", array("am", "PLACE2", "PLACE3", "TIP_SV4", "PLACE5"));?>" class="filter_item_m  <?=(isset($_GET["PLACE1"]))?"active_filt_i_m":"";?>">Кухня</a>
		<a href="<?=$APPLICATION->GetCurPageParam("PLACE2=41546", array("am", "PLACE1", "PLACE3", "TIP_SV4", "PLACE5"));?>" class="filter_item_m  <?=(isset($_GET["PLACE2"]))?"active_filt_i_m":"";?>">Гостинная</a>
		<a href="<?=$APPLICATION->GetCurPageParam("PLACE3=41550", array("am", "PLACE2", "PLACE1", "TIP_SV4", "PLACE5"));?>" class="filter_item_m  <?=(isset($_GET["PLACE3"]))?"active_filt_i_m":"";?>">Спальня</a>
		<a href="<?=$APPLICATION->GetCurPageParam("PLACE4=41549", array("am", "PLACE2", "PLACE3", "TIP_SV1", "PLACE5"));?>" class="filter_item_m  <?=(isset($_GET["PLACE4"]))?"active_filt_i_m":"";?>">Прихожая</a>
		<a href="<?=$APPLICATION->GetCurPageParam("PLACE5=41547", array("am", "PLACE2", "PLACE3", "TIP_SV4", "PLACE1"));?>" class="filter_item_m  <?=(isset($_GET["PLACE5"]))?"active_filt_i_m":"";?>">Детская комната</a>
	</div>
</div>