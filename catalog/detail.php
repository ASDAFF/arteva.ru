...
$APPLICATION->SetPageProperty("title", "Каталог детальная");
$APPLICATION->SetPageProperty("keywords", "Каталог детальная");
$APPLICATION->SetPageProperty("description", "Каталог детальная");
$APPLICATION->SetTitle("Каталог детальная");?>
<?
